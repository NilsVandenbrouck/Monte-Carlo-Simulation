...
from .tables.hashtable import FLUSH
from .tables.hashtable5 import NO_FLUSH_5
from .tables.hashtable6 import NO_FLUSH_6
from .tables.hashtable7 import NO_FLUSH_7
from .tables.dptables import SUITS
from .tables.__init__ import (
    BINARIES_BY_ID,
    SUITBIT_BY_ID,
    )
